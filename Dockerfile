...
ARG VITE_BOT_INSTALLATION_URL
ARG TRACKING_BOT_CLIENT_ID
ARG OPENAI_API_KEY
ARG RESEND_API_KEY
ARG SERVER_PORT
...
ENV VITE_BOT_INSTALLATION_URL=${VITE_BOT_INSTALLATION_URL}
ENV TRACKING_BOT_CLIENT_ID=${TRACKING_BOT_CLIENT_ID}
ENV OPENAI_API_KEY=${OPENAI_API_KEY}
ENV RESEND_API_KEY=${RESEND_API_KEY}
ENV SERVER_PORT=${SERVER_PORT}
ENV VITE_PUBLIC_WS_URL=${VITE_PUBLIC_WS_URL}
ENV VITE_APP_PUBLIC_POSTHOG_KEY=${VITE_APP_PUBLIC_POSTHOG_KEY}
ENV VITE_APP_PUBLIC_POSTHOG_HOST=${VITE_APP_PUBLIC_POSTHOG_HOST}
ENV VITE_API_KEY=${VITE_API_KEY}
ENV VITE_POI_API_KEY=${VITE_POI_API_KEY}
